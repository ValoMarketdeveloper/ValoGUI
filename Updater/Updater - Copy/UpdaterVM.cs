    ...
    public class UpdaterVM : NotificationObject
    {
        public class DisplayData : NotificationObject
        {
            public DisplayData()
            {
                ...
                {
                    new DataGridTextColumn() { Header = "Distributor Name", Binding = new Binding("DistributorName"), IsReadOnly = true  },
                    new DataGridTextColumn() { Header = "Distributor Product ID", Binding = new Binding("DistributorProductID"), IsReadOnly = true },
                ...
                {
                    new DataGridTextColumn() { Header = "Market Place Name", Binding = new Binding("MarketPlaceName"), IsReadOnly = true },
